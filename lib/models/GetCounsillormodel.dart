class GetcounsellorDetailModal {
  String accessToken;
  String mediaUrl;
  Meta meta;
  String refreshToken;
  Counsillor counsellor;

  GetcounsellorDetailModal(
      {this.accessToken,
        this.mediaUrl,
        this.meta,
        this.refreshToken,
  ...
  GetcounsellorDetailModal.fromJson(Map<String, dynamic> json) {
    accessToken = json['access_token'];
    mediaUrl = json['media_url'];
    meta = json['meta'] != null ? new Meta.fromJson(json['meta']) : null;
    refreshToken = json['refresh_token'];
    counsellor = json['counsellor'] != null
        ? new Counsillor.fromJson(json['counsellor'])
        : null;
  }
...
class Counsillor {
  ...
  Counsillor.fromJson(Map<String, dynamic> json) {
    aadhar = json['aadhar'];
    about = json['about'];
    ...
    multiple_sessions=json['multiple_sessions'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['multiple_sessions']=this.multiple_sessions;
