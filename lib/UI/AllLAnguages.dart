...
class AllLanguage extends StatefulWidget {
  const AllLanguage({Key key}) : super(key: key);

  @override
  _ProfessionalInfo1State createState() => _ProfessionalInfo1State();
}

class _ProfessionalInfo1State extends State<AllLanguage> {
  ...
  Future<void> uploadkyc() async {
    ...
    Map<String, dynamic> body={
      ...
      "resume": "",
      "timezone": "GMT+5:30",
      "topic_ids": selectedInterestList.toString().replaceAll("]", "").replaceAll("[", "")
    };
